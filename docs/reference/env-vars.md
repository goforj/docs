...
| `APP_MAINTENANCE_ENABLED` | `false` | Return HTTP 503 for application traffic while keeping health, readiness, metrics, and Lighthouse routes available. Restart the App after changing it. |
