...
<p align="center">
    ...
    <a href="https://github.com/goforj/env/blob/main/LICENSE"><img src="https://img.shields.io/badge/license-MIT-blue.svg" alt="License: MIT"></a>
...
### v2.6 behavior notes {#v2.6-behavior-notes}
...
### v2.5 behavior notes {#v2.5-behavior-notes}
...
## Debug output and secrets {#debug-output-and-secrets}
...
Documented examples are generated directly from function documentation into [`./examples`](https://github.com/goforj/env/tree/main/examples), so the README, GoDoc, and example programs share one source. CI regenerates them to detect drift and builds every generated program without build tags. Examples that intentionally demonstrate panic behavior are compiled rather than executed.
...
### IsAppEnvLocalOrStaging {#isappenvlocalorstaging}
...
### IsAppEnvProduction {#isappenvproduction}
...
### IsAppEnvStaging {#isappenvstaging}
...
### IsAppEnvTesting {#isappenvtesting}
...
### IsAppEnvTestingOrLocal {#isappenvtestingorlocal}
...
### IsHostEnvironment {#ishostenvironment}
...
### Scope.ChildNames {#scope-childnames}
