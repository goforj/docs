...
<p align="center">
  ...
  <a href="https://github.com/goforj/storage/blob/main/LICENSE"><img src="https://img.shields.io/badge/license-MIT-blue.svg" alt="License: MIT"></a>
...
### Single-backend construction {#single-backend-construction}
...
### Manager and named disks {#manager-and-named-disks}
...
### rclonestorage.LocalRemote {#rclonestorage-localremote}
...
### rclonestorage.MustRenderLocal {#rclonestorage-mustrenderlocal}
...
### rclonestorage.MustRenderS3 {#rclonestorage-mustrenders3}
...
### rclonestorage.RenderLocal {#rclonestorage-renderlocal}
...
### rclonestorage.RenderS3 {#rclonestorage-renders3}
...
### rclonestorage.S3Remote {#rclonestorage-s3remote}
...
### CountFilesContext {#countfilescontext}
...
### PagedStorage.ListPage {#pagedstorage-listpage}
...
### Storage.MakeDir {#storage-makedir}
...
### Storage.WithContext {#storage-withcontext}
...
### dropboxstorage.Config {#dropboxstorage-config}
...
### ftpstorage.Config {#ftpstorage-config}
...
### gcsstorage.Config {#gcsstorage-config}
...
### memorystorage.Config {#memorystorage-config}
...
### rclonestorage.Config {#rclonestorage-config}
...
### s3storage.Config {#s3storage-config}
...
### sftpstorage.Config {#sftpstorage-config}
...
### dropboxstorage.New {#dropboxstorage-new}
...
### memorystorage.New {#memorystorage-new}
...
### rclonestorage.New {#rclonestorage-new}
...
### sftpstorage.New {#sftpstorage-new}
