...
<p align="center">
  <img src="https://raw.githubusercontent.com/goforj/filesystem/main/docs/images/logo.png?v=2" width="400" alt="filesystem logo">
</p>
...
### Rclone Backends (add-on) {#rclone-backends-(add-on)}
...
### Rclone (any backend) {#rclone-(any-backend)}
```go
_ "github.com/goforj/filesystem-rclone"
...
### Rclone (env-only remote) {#rclone-(env-only-remote)}
...
## Rclone Config Sources {#rclone-config-sources}
