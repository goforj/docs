...
- `/workspace/code/goforj/docs/designs/app-composition-layout-design.md`
...
- scheduler runtime templates live under `/workspace/code/goforj/templates/internal/schedules`
- App-owned schedule implementations are generated by `/workspace/code/goforj/templates/internal/makecmd/make_schedule_cmd.go.tmpl`
- App-owned schedule providers are preserved in `/workspace/code/goforj/templates/wire/inject_scheduler_schedules.go.tmpl`
...
- `/workspace/code/goforj/cmd/forj/app_passthrough.go`
- `/workspace/code/goforj/cmd/forj/main.go`
- `/workspace/code/goforj/internal/build/run_cmd.go`
- `/workspace/code/goforj/templates/internal/cmd/root_cmd.go.tmpl`
- `/workspace/code/goforj/templates/internal/cmd/skip_boot.go.tmpl`
